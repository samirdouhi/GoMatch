...
namespace BusinessService.Data.Configuration
{
    public class PhotoCommerceConfiguration : IEntityTypeConfiguration<PhotoCommerce>
    {
        public void Configure(EntityTypeBuilder<PhotoCommerce> builder)
        {
            ...
            builder.Property(p => p.NomFichier).IsRequired().HasMaxLength(260);
            builder.Property(p => p.CheminFichier).IsRequired().HasMaxLength(500);
            builder.Property(p => p.TypeContenu).IsRequired().HasMaxLength(100);
            builder.Property(p => p.TailleFichier).IsRequired();
            builder.Property(p => p.Ordre).HasDefaultValue(0);
