...
namespace BusinessService.Controllers
{
    ...
    public class PhotosCommercesController : ControllerBase
    {
        ...
        /// <summary>Liste des métadonnées photo d'un commerce.</summary>
        [AllowAnonymous]
        [HttpGet]
        ...
        /// <summary>Télécharge le fichier image d'une photo.</summary>
        [AllowAnonymous]
        ...
        /// <summary>Supprime une photo (réservé au propriétaire).</summary>
        [Authorize]
        [HttpDelete("{photoId}")]
