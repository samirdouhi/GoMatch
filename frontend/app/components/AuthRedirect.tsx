...
/**
 * Composant silencieux : redirige l'admin vers /admin si un token valide
 * (ou rafraîchissable) est présent dans le localStorage.
 * Règle le problème de fermeture du navigateur : le cookie peut expirer
 * mais le token reste dans localStorage.
 */
