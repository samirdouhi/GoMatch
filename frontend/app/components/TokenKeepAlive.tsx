...
/**
 * TokenKeepAlive — composant invisible monté dans ClientShell.
 * Vérifie toutes les 60 secondes si l'access token va expirer dans moins de
 * 2 minutes. Si oui, tente un refresh silencieux. Si le refresh échoue (refresh
 * token expiré/révoqué), nettoie les tokens et redirige vers /signin.
 */
...
export default function TokenKeepAlive() {
  ...
  useEffect(() => {
    ...
    // Vérification immédiate au montage (couvre le cas d'un rechargement de page)
    void check();
