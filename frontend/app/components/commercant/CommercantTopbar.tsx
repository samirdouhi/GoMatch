...
export default function CommercantTopbar() {
  ...
  return (
    <header className="sticky top-0 z-30 border-b border-black/[0.07] bg-white/90 dark:border-white/[0.07] dark:bg-[#04060b]/90 backdrop-blur-xl">
      <div className="flex h-16 items-center justify-between px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2">
          <button
            type="button"
            className="flex h-9 w-9 items-center justify-center rounded-xl border border-black/[0.07] bg-black/[0.03] text-slate-500 transition hover:bg-black/[0.06] hover:text-slate-900 dark:border-white/[0.07] dark:bg-white/[0.03] dark:text-zinc-400 dark:hover:bg-white/[0.06] dark:hover:text-white"
          ...
          <div className="ml-1 rounded-full border border-orange-500/25 bg-orange-500/10 px-3 py-1.5 text-[10px] font-black uppercase tracking-[0.18em] text-orange-500 dark:text-orange-400">
            Commerçant
          </div>
        </div>
      </div>
